...
echo color("nevy","▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬TEAM GHOIB▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ \n");
echo color("yellow","[•] Time : ".date('[d-m-Y] [H:i:s]')." \n");
echo color("yellow","[•] BACA DOA DULU GAES \n");
echo color("yellow","[•] TULIS NOMERE 62xxxxxxxxxx \n");
echo color("nevy","▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬BISMILLAH▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ \n");
function change(){
$nama = nama();
...
echo color("green","+] Kodene sampun di kirim njih")."\n";
otp:
echo color("nevy","?] Otp: ");
...
echo color("green","+] Wes berhasil daftar om");
...
echo color("red","-] GAGAL MBAH!!!\n");
}
}else{
goto setpin;
}
}else{
echo color("red","-] Otp mu keliru om");
echo"\n==================================\n\n";
echo color("yellow","!] Input meneh jal\n");
goto otp;
}
}else{
